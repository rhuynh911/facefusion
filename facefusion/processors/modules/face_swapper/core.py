...
def swap_face(source_face : Face, source_vision_frame : Optional[VisionFrame], target_face : Face, temp_vision_frame : VisionFrame) -> VisionFrame:
	...
	for pixel_boost_vision_frame in pixel_boost_vision_frames:
		...
		pixel_boost_vision_frame = forward_swap_face(source_face, source_vision_frame, target_face, pixel_boost_vision_frame)
...
def forward_swap_face(source_face : Face, source_vision_frame : Optional[VisionFrame], target_face : Face, crop_vision_frame : VisionFrame) -> VisionFrame:
...
def process_frame(inputs : FaceSwapperInputs) -> ProcessorOutputs:
	...
	if source_face and target_faces:
		...
		for target_face in target_faces:
			...
			temp_vision_frame = swap_face(source_face, source_frame, target_face, temp_vision_frame)
